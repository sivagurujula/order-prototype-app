...
const getAddresses = ()=>{
  ...
  console.log('postCode: ',postCode.current.value)
  props.fetchAddresses();
}
const postCode = React.useRef('');
//let [postCode] = React.useState({});
  return (
    <React.Fragment>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} sm={6}>
        <Button onClick={getAddresses} variant="contained"
                    color="primary" >
                      Get Address
                    </Button>
        </Grid>
        ...
        id="shipping-address"
        clearOnEscape
        renderInput={(params) => <TextField {...params} required label="Address" margin="normal" />}
      />
        </Grid>
        <Grid item xs={12} sm={6}>
